...
public class ChaseState : State
{
    ...
    public override void OnUpdate()
    {
        ...
        else
        {
            ...
            owner.movement.MoveTowards(owner.percived[0].transform.position);

            // create a direction vector toward the perceieved object from the owner
            Vector3 direction = owner.percived[0].transform.position - owner.transform.position;
